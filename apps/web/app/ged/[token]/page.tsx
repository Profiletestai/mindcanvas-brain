// apps/web/app/ged/[token]/page.tsx
"use client";
...
export default function GedResultPage({ params }: { params: { token: string } }) {
  ...
  // Keep using the same QSC result API because GED reuses the same scoring model/data.
    ...
    return (
      <div className="min-h-screen bg-slate-950 text-slate-50">
        ...
        <main className="mx-auto max-w-5xl px-4 py-12 space-y-4">
          ...
          <p className="text-sm text-slate-300">We couldn&apos;t load your Growth Engine Diagnostic result.</p>
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 md:py-12 space-y-10">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h1 className="mt-3 text-3xl md:text-4xl font-bold tracking-tight">
                Your Growth Engine Snapshot
              </h1>
              <p className="mt-2 text-sm text-slate-300 max-w-2xl">
                This view combines your <span className="font-semibold">Personality Layer</span> and{" "}
                <span className="font-semibold">Mindset Layer</span> into one combined Growth Engine
                Diagnostic profile.
              </p>
            </div>

            <div className="flex md:items-end">
              <span className="inline-flex items-center rounded-xl border border-slate-700 bg-slate-900/70 px-4 py-2 text-sm font-medium text-slate-300">
                Full diagnostic coming next
              </span>
            </div>
          </div>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-950/80 p-6 md:p-7 shadow-lg shadow-black/40">
            ...
            <p className="mt-1 text-sm text-slate-300">
              Your natural style across Fire, Flow, Form and Field.
            </p>
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-950/80 p-6 md:p-7 shadow-lg shadow-black/40">
            ...
            <p className="mt-1 text-sm text-slate-300">
              Where you are in your current business growth journey.
            </p>
        ...
        <section className="space-y-4">
          <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
            <div>
              <h2 className="text-xl md:text-2xl font-semibold">Growth Engine Matrix</h2>
              <p className="mt-1 text-sm text-slate-300 max-w-2xl">
                This grid maps your <span className="font-semibold">Personality Layer</span> (left to
                right) against your <span className="font-semibold">Mindset Layer</span> (top to bottom).
                Your combined profile sits at the intersection.
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 overflow-x-auto">
            <div className="inline-grid grid-cols-[auto_repeat(4,minmax(140px,1fr))] gap-3 md:gap-4 items-stretch">
              ...
              {PERSONALITIES.map((p) => (
                ...
                >
                  <div>{p.label}</div>
                  <div className="text-[11px] text-slate-500">Personality {p.code}</div>
                </div>
              ))}
                      ...
                      >
                        ...
                        {cat === "related" && (
                          <div className="mt-2 text-[11px] text-slate-200/85">
                            Related personality or mindset
                          </div>
                        )}
                      </div>
                    );
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-[11px] text-slate-300">
            ...
            <div className="inline-flex items-center gap-2">
              ...
              <span>Related personalities or mindsets</span>
            </div>
            <div className="inline-flex items-center gap-2">
