...
export default function GedEntrepreneurStrategicReportPage({
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!j.results) {
          throw new Error("No GED results found");
        }
  ...
  async function handleDownloadPdf() {
    ...
    try {
      ...
      pdf.save(`growth-engine-diagnostic-strategic-${token}.pdf`);
    } finally {
      ...
      <div className="relative min-h-screen bg-[#020617] text-slate-50">
        ...
        <main className="mx-auto max-w-5xl px-4 py-12 space-y-4">
          ...
          <h1 className="mt-3 text-3xl font-bold">
            Preparing your Growth Engine Diagnostic report…
          </h1>
          {apiVersion && (
      ...
      <div className="relative min-h-screen bg-[#020617] text-slate-50">
        ...
        <main className="mx-auto max-w-5xl px-4 py-12 space-y-4">
          ...
          <p className="text-sm text-slate-300">
            We weren&apos;t able to generate your Growth Engine Diagnostic — Strategic
            Growth Report.
          </p>
    ...
    <div className="min-h-screen bg-slate-950 text-slate-300">
      ...
      >
        <header className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <h1 className="mt-3 text-3xl md:text-4xl font-bold tracking-tight text-slate-50">
              Growth Engine Diagnostic — Strategic Growth Report
            </h1>
            {takerDisplayName && (
            ...
            <p className="mt-2 text-sm text-slate-300 max-w-2xl">
              ...
              on your combined profile and current mindset stage.
            </p>
          </div>
          ...
          <div className="flex flex-col items-end gap-2 text-xs text-slate-400">
            <div className="flex flex-wrap items-center justify-end gap-2">
              <button
                ...
                className="inline-flex items-center rounded-lg border border-slate-600 bg-slate-900 px-3 py-1.5 text-xs font-medium text-slate-50 hover:bg-slate-800 disabled:opacity-60"
              >
        ...
        <section className="rounded-3xl bg-white shadow-sm border border-slate-200 p-6 md:p-8 space-y-4">
          ...
          <h2 className="text-2xl font-semibold text-slate-900">{personaName}</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 pt-4 border-t border-slate-200">
            ...
            <div>
              <h3 className="text-sm font-semibold mb-1 text-slate-900">Your Mindset Layer</h3>
              <p className="text-sm text-slate-700">
        ...
        <section className="rounded-3xl bg-[#f5eddc] border border-amber-200 p-6 md:p-8 space-y-4">
          ...
          <div className="grid gap-6 md:grid-cols-3 pt-4">
            <div className="rounded-2xl bg-white/70 border border-amber-200 p-4 text-sm space-y-2">
              <h3 className="font-semibold text-slate-900">Growth profile</h3>
            ...
            <div className="rounded-2xl bg-white/70 border border-amber-200 p-4 text-sm space-y-2">
              <h3 className="font-semibold text-slate-900">Top strategic priorities</h3>
        ...
        <section className="grid gap-6 md:grid-cols-2 items-start">
          <div className="rounded-3xl bg-[#020617] text-slate-50 border border-slate-800 p-6 md:p-7 space-y-4">
            <h2 className="text-lg font-semibold">Personality Layer</h2>
            <p className="text-sm text-slate-300">
          ...
          <div className="rounded-3xl bg-[#020617] text-slate-50 border border-slate-800 p-6 md:p-7 space-y-4">
            <h2 className="text-lg font-semibold">Mindset Layer</h2>
            <p className="text-sm text-slate-300">
              Where your focus and energy are distributed across the 5 growth
              stages.
            </p>
        ...
        <section className="rounded-3xl bg-white shadow-sm border border-slate-200 p-6 md:p-8 space-y-4">
          ...
          <h2 className="text-xl font-semibold text-slate-900">
            Where your personality layer meets your mindset stage
          </h2>
          <p className="text-sm text-slate-700">
            Each cell represents a different growth profile. Your primary
        ...
        <section className="rounded-3xl bg-white shadow-sm border border-slate-200 p-6 md:p-8 space-y-4">
          ...
          <h2 className="text-xl font-semibold text-slate-900">
            How you show up emotionally and behaviourally
          </h2>
          ...
          <div className="grid gap-6 md:grid-cols-3 pt-2 text-sm">
            ...
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
              <h3 className="font-semibold text-slate-900">What energises you</h3>
              <p className="mt-1 text-slate-700 whitespace-pre-line">
                {persona?.energisers || "—"}
              </p>
            </div>
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
              <h3 className="font-semibold text-slate-900">What drains you</h3>
              <p className="mt-1 text-slate-700 whitespace-pre-line">
                {persona?.drains || "—"}
              </p>
            </div>
        ...
        <section className="rounded-3xl bg-white shadow-sm border border-slate-200 p-6 md:p-8 space-y-4">
          ...
          <div className="grid gap-6 md:grid-cols-3 pt-2 text-sm">
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
              <h3 className="font-semibold text-slate-900">Strategic strengths</h3>
              <p className="mt-1 text-slate-700 whitespace-pre-line">
                {combinedStrengths}
              </p>
            </div>
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
              <h3 className="font-semibold text-slate-900">Growth risks & loops</h3>
              <p className="mt-1 text-slate-700 whitespace-pre-line">
                {combinedRisks}
              </p>
            </div>
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
              <h3 className="font-semibold text-slate-900">Your biggest lever</h3>
              <p className="mt-1 text-slate-700 whitespace-pre-line">
                {combinedLever}
              </p>
            </div>
        ...
        <section className="rounded-3xl bg-white shadow-sm border border-slate-200 p-6 md:p-8 space-y-4">
          ...
          <div className="grid gap-6 md:grid-cols-3 pt-2 text-sm">
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
              <h3 className="font-semibold text-slate-900">What stabilises you</h3>
              <p className="mt-1 text-slate-700 whitespace-pre-line">
                {emotionalStabilises}
              </p>
            </div>
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
              <h3 className="font-semibold text-slate-900">What destabilises you</h3>
              <p className="mt-1 text-slate-700 whitespace-pre-line">
                {emotionalDestabilises}
              </p>
            </div>
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
              <h3 className="font-semibold text-slate-900">Support yourself better</h3>
              <p className="mt-1 text-slate-700 whitespace-pre-line">
                {supportYourself}
              </p>
            </div>
