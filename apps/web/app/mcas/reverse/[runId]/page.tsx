...
export default async function Page(
  ...
  const topOs = scoring?.primary_operating_style || null;
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
          ...
          <div>
            ...
            <div className="mt-2 text-sm text-white/60">
              ...
              <span className="text-white">
                {payload?.framework?.slug || "mcas-core-alignment"}{" "}
                {payload?.framework?.version || "v1"}
              </span>
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            ...
            <div className="mt-2 font-medium">{scoring?.model_version || "—"}</div>
            <div className="mt-3 text-xs text-white/50">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            ...
            <div className="mt-2 text-sm text-white/80">
              This page shows the exact structured result and wording output a partner
              platform can use to interpret and apply the reverse profile.
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-6">
          <div className="text-sm text-white/60">Wording Output</div>
          <div className="mt-1 text-lg font-semibold">
            Language signals for Ideal Job Profile generation
          </div>
